        ...
        <div className="container mx-auto px-6 lg:px-16 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg text-slate-600 leading-relaxed max-w-xl">
              Mindsmiratus Technologies is a digital solutions company dedicated to helping businesses grow with smart, modern, and
              scalable technology. Since our beginning in 2016, we’ve focused on delivering meaningful solutions that
              make a real difference — whether it’s building high-performing websites, creating user-friendly digital products, or running result-driven marketing campaigns.
            </p>
          </div>
