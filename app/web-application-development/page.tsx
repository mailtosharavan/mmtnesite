...
export default function WebApplicationDevelopmentPage() {
  ...
  const faqs = [
    ...
    {
      q: "What does your Web Application Development service include?",
      a: "Our Web Application Development service covers everything from planning, UI/UX design, backend development, API integrations, and database setup to testing, deployment, and ongoing support.We build custom web applications, business portals, SaaS platforms, dashboards, and automation systems based on your exact requirements.",
    },
    {
      q: "Can you integrate payment gateways, CRMs, and third-party APIs into the application?",
      a: "Absolutely. We regularly integrate APIs such as Razorpay, Stripe, PayPal, Zoho, Salesforce, WhatsApp API, OTP systems, and more.API development and integration a key part of our Web App Development services.",
    },
    {
      q: "How secure are your Web Applications?",
    ...
    <>
      ...
      <section className="relative overflow-hidden py-24 bg-gradient-to-br from-sky-50 via-white to-cyan-50">
        <div className="container mx-auto px-6 lg:px-16 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left">
            <h1 className="text-4xl font-extrabold text-slate-900 leading-snug web-h1">
            ...
            <p className="mt-6 text-lg text-slate-600 leading-relaxed">
              We develop secure, high-performing web applications that streamline operations, reduce manual work, and help businesses
              scale faster. From dashboards to portals to custom automation systems — we build solutions that truly solve problems.
      ...
      <section className="py-20 bg-white ">
        <div className="container mx-auto px-6 lg:px-16 text-center max-w-4xl modern">
          <h2 className="text-3xl font-bold text-slate-900">Modern Web Application Development for Growing Businesses
          </h2>
          <p className="mt-5 text-slate-600 text-lg leading-relaxed">
            Your business has unique workflows — your web application should support them, not limit them.<br></br>
            We design and develop custom web apps that simplify processes, integrate smoothly <br></br>with your tools, and deliver a seamless experience to your users.
            <br></br><br></br>Whether you need an internal dashboard, a customer portal, a SaaS product, or a fully <br></br>customized automation system — our team builds solutions engineered for long-term growth.
      ...
      <section className="py-24 bg-gradient-to-br from-sky-600 to-cyan-600 text-white">
        <div className="container mx-auto px-6 lg:px-16 grid lg:grid-cols-2 gap-16">
          ...
          <div className="bg-white text-slate-900 p-10 rounded-3xl shadow-xl">
            <h3 className="text-2xl font-bold mb-4 ready-to">Ready to Build Your Web Application?</h3>
