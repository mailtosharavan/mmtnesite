...
import { Facebook, Linkedin, Twitter, Mail, Phone, Smartphone } from "lucide-react";
        ...
        <div className="container mx-auto px-6 pb-16 grid gap-12 md:grid-cols-4">
          ...
          <motion.div {...fadeIn(0)}>
            ...
            <p className="text-sm mt-2 flex items-center justify-center md:justify-start gap-2">
              ...
              <a href="mailto:mail@mindsmiratus.com" className="hover:text-white transition">mail@mindsmiratus.com</a>
            </p>
            <p className="text-sm mt-2 flex items-center justify-center md:justify-start gap-2">
              <Smartphone size={16} className="text-blue-400" />
              <a href="tel:+919625306474" className="hover:text-white transition">+91-9625306474</a>
            </p>
            <p className="text-sm mt-2 flex items-center justify-center md:justify-start gap-2">
              <Phone size={16} className="text-blue-400" />
              <a href="tel:+01144786201" className="hover:text-white transition">+011 44786201</a>
            </p>
          </motion.div>
